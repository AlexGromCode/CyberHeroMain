...
public class MailManager : MonoBehaviour
{
    ...
    private void CheckAnswers()
    {
        ...
        if (allAnswersCorrect)
        {
            ...
            _dialogueFakeMail.ShowLineExtra(indexExtrsLine: 0, scene: 1, indexImage: 0, indexVoice: 0);
        }
        else
        {
            _dialogueFakeMail.OnDialogue();
            _dialogueFakeMail.ShowLineExtra(indexExtrsLine: 1, scene: 4, indexImage: 1,indexVoice: 1);
        }
    }
}