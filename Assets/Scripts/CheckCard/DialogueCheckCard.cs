...
public class DialogueCheckCard : MonoBehaviour
{
    ...
    private bool _isExtraLineActive;
    ...
    {
        if (_isExtraLineActive)
        {
            HideDialogue();
            return;
        }
        else if (_isSkipTextButton)
        {
    ...
    public void ShowLineExtra(int indexExtrsLine, int indexImage, int indexVoice)
    {
        GM.IsPlayingRoomCheckCard = false;

        _isExtraLineActive = true;
        _isSkipTextButton = true;
        _dialogText.text = string.Empty;
    ...
    public void HideDialogue()
    {
        ...
        GM.IsPlayingRoomCheckCard = true;
    }
